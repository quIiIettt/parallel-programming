...
public class VectorMatrixMult {
  public static void main( String args[]) {
    ...
    Exchanger<DataClass> exchanger14 = new Exchanger<DataClass>();
    Exchanger<DataClass> exchanger23 = new Exchanger<DataClass>();
    Exchanger<DataClass> exchanger36 = new Exchanger<DataClass>();
    Exchanger<DataClass> exchanger45 = new Exchanger<DataClass>();
    Exchanger<DataClass> exchanger56 = new Exchanger<DataClass>();
